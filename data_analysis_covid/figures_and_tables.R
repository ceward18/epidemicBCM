...
pdf('./figures/fig8_nyc_data.pdf', width = 6, height = 3)
...
pdf('./figures/fig9_nyc_alarms.pdf', width = 8, height = 5)
...
pdf('./figures/fig10_nyc_r0_postPred.pdf', height = 11, width = 17)
