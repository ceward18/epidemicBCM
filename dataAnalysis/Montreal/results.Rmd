...
montrealNew$timePeak1[6:(max(which(montrealNew$peak == 1)) + 99)] <-
  1:(max(which(montrealNew$peak == 1)) + 99 - 5)

montrealNew$timePeak2[(min(which(montrealNew$peak == 2)) + 1):(max(which(montrealNew$peak == 2)) + 99)] <-
  (min(which(montrealNew$peak == 2)) + 1):(max(which(montrealNew$peak == 2)) + 99) -
  min(which(montrealNew$peak == 2))

montrealNew$timePeak3[(min(which(montrealNew$peak == 3)) + 1):(max(which(montrealNew$peak == 3)) + 99)] <-
  (min(which(montrealNew$peak == 3)) + 1):(max(which(montrealNew$peak == 3)) + 99) -
  min(which(montrealNew$peak == 3))

montrealNew$timePeak4[(min(which(montrealNew$peak == 4)) + 1):(max(which(montrealNew$peak == 4)) + 99)] <-
  (min(which(montrealNew$peak == 4)) + 1):(max(which(montrealNew$peak == 4)) + 99) -
  min(which(montrealNew$peak == 4))

montrealNew$timePeak5[(min(which(montrealNew$peak == 5)) + 1):(max(which(montrealNew$peak == 5)) + 99)] <-
  (min(which(montrealNew$peak == 5)) + 1):(max(which(montrealNew$peak == 5)) + 99) -
