...
```{r}
chains <- readRDS('Output/chains_spline_exp_peak4_60_1.rds')
...
```{r}
chains <- readRDS('Output/chains_spline_exp_peak4_60_2.rds')
...
```{r}
chains <- readRDS('Output/chains_spline_exp_peak4_60_3.rds')
...
```{r}
chains <- readRDS('Output/chains_spline_exp_peak4_60_4.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak1_1_1.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak1_1_4.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak4_1_1.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak4_1_2.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak4_1_3.rds')
...
```{r}
chains <- readRDS('Output/chains_betatSpline_exp_peak4_1_4.rds')
