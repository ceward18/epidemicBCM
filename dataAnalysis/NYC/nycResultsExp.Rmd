...
Modeling each peak separately. Investigating the different alarm functions and different levels of smoothing to inform the alarm functions: 14 day, 30 day, 45 day, 60 day averages.
...
paramsPeak <- paramsPeak[paramsPeak$param %in% c('rateI'),]
...
prior <- data.frame(param = 'rateI',
                    mean = 0.2,
                    lower = qgamma(0.025, aa, bb),
                    upper = qgamma(0.975, aa, bb),
                    alarmFit= 'Prior',
                    smoothWindow = c(1, 14, 30, 45, 60))
