...
```{r}
chains <- readRDS('Output/chains_thresh_exp_peak3_30.rds')
...
```{r}
chains <- readRDS('Output/chains_thresh_exp_peak3_45.rds')
...
```{r}
chains <- readRDS('Output/chains_thresh_exp_peak3_60.rds')
