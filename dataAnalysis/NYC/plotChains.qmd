...
```{r}
chains <- readRDS('Output/chains_thresh_exp_peak4_60.rds')
...
-   AF Slice: beta, delta, nu, x0, rateI
...
```{r}
chains <- readRDS('Output/chains_power_exp_peak4_60.rds')
...
```{r}
chains <- readRDS('Output/chains_gp_exp_peak3_15.rds')
