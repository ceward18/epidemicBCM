...
grAll <- grAll[grAll$infPeriod == 'fixed',]
...
paramsPostAll <- paramsPostAll[paramsPostAll$infPeriod == 'fixed',]
...
alarmAll <- alarmAll[alarmAll$infPeriod == 'fixed',]
...
waicAll<- waicAll[waicAll$infPeriod == 'fixed',]
