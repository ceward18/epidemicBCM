...
paramsPostAll <- paramsPostAll[paramsPostAll$infPeriod == 'exp',]
...
paramsPostAll$param <- factor(paramsPostAll$param , 
                              ...
                              labels=c('beta', 'delta', 'H', 'k', 'nu', 'x[0]', 'rateI'))
...
alarmAll <- alarmAll[alarmAll$infPeriod == 'exp',]
...
p1 <- ggplot() +  
    ...
    facet_wrap(~alarmFit, scales = 'free_x') 
...
trueCurveThresh14 <- readRDS(paste0('./Data/thresh_exp_14.rds'))[simNumber,]
trueCurveThresh30 <- readRDS(paste0('./Data/thresh_exp_30.rds'))[simNumber,]
trueCurveHill14 <- readRDS(paste0('./Data/hill_exp_14.rds'))[simNumber,]
trueCurveHill30 <- readRDS(paste0('./Data/hill_exp_30.rds'))[simNumber,]
trueCurvePower14 <- readRDS(paste0('./Data/power_exp_14.rds'))[simNumber,]
trueCurvePower30 <- readRDS(paste0('./Data/power_exp_30.rds'))[simNumber,]
...
# get true epidemic curves for each scenario
trueCurveThresh14 <- readRDS(paste0('./Data/thresh_exp_14.rds'))[simNumber, 1:100]
trueCurveThresh30 <- readRDS(paste0('./Data/thresh_exp_30.rds'))[simNumber, 1:100]
trueCurveHill14 <- readRDS(paste0('./Data/hill_exp_14.rds'))[simNumber, 1:100]
trueCurveHill30 <- readRDS(paste0('./Data/hill_exp_30.rds'))[simNumber, 1:100]
trueCurvePower14 <- readRDS(paste0('./Data/power_exp_14.rds'))[simNumber, 1:100]
trueCurvePower30 <- readRDS(paste0('./Data/power_exp_30.rds'))[simNumber, 1:100]
...
waicAll<- waicAll[waicAll$infPeriod == 'exp',]
...
waicSelected$selected <- factor(waicSelected$selected,
                                levels = c('thresh', 'hill', 'power', 'gp', 
                                           'spline', 'betatSpline', 'basic'))
